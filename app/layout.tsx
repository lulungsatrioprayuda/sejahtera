...
export const metadata = {
    title: 'UD. Sejahtera | Landing Page',
    description: 'UD. Sejahtera adalah UD yang beroperasi dalam bidang minuman dan makanan ringan, dengan pengalaman dari tahun 2017 sampai sekarang.',
}
